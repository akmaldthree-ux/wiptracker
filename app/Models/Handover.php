...
class Handover extends Model {
    protected $fillable = ['handover_no','production_order_id','from_station_id','to_station_id','status','initiated_by','confirmed_by','approved_by','notes','condition_notes','initiated_at','confirmed_at'];
