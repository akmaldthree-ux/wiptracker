...
<div class="d-flex justify-content-between align-items-start mb-4">
  <div>
    ...
    <p class="text-muted mb-0">{{ $handover->fromStation?->name ?? 'Production Order' }} → {{ $handover->toStation->name }} | Order: {{ $handover->order->order_no }}</p>
  </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <table class="table table-sm table-borderless mb-0">
          ...
          <tr><td class="text-muted">Dari</td><td class="fw-semibold">{{ $handover->fromStation?->name ?? '📋 Production Order' }}</td></tr>
